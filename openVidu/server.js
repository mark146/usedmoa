/* CONFIGURATION */
// OpenVidu 세션에 진입하기 위한 토큰을 관리하기 위한 앱 및 컨트롤러의 진입점
...
var options = {
    ca : fs.readFileSync('/etc/letsencrypt/live/www.usedmoa.co.kr/fullchain.pem'),
    key: fs.readFileSync('/etc/letsencrypt/live/www.usedmoa.co.kr/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/www.usedmoa.co.kr/cert.pem')
};
...
app.post('/api/recording/stop', function (req, res) {
    ...
    OV.stopRecording(recordingId)
        .then(recording => {
            ...
            console.log("Stopping recording - server.js - {recordingId}=" + recordingId);
