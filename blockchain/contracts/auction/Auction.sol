...
// 참고 : https://github.com/qkdxorjs1002/dapp_auction/blob/main/Auction.sol
/*
contract Auction {
    ...
    function Auction(string _url, string _pagehash, uint _deadline,
    uint _initValue, uint _raiseLimit) {
        owner = msg.sender;
        numUsers = 0;
        value = _initValue;
        isEnd = false;
